...
from rest_framework.permissions import IsAuthenticated   #IsAuthenticatedOrReadOnly desek auth bolbogondor da okuy alat
...
class HelloApiView(APIView):
    ...
    def patch(self,request,pk=None):
        """Handling a partial update of an obj"""
